...
export function WhatsAppButton() {
  const url = `https://wa.me/${cliente.contacto.whatsapp}?text=${encodeURIComponent(
    cliente.contacto.whatsappMensaje
  )}`;
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-tema-texto-claro shadow-lg transition-transform duration-200 ease-out hover:scale-105 active:scale-95"
    >
